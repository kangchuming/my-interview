                ...
                {msg.type === "candidate" && (
                  <div className="flex items-center gap-4 ml-16">
                    <div className="flex-1">
                      ...
                      <div className="bg-lime-100 rounded-lg p-4 shadow-sm border border-gray-200">
                        <p className="text-emerald-800 leading-relaxed mb-3">{msg.content}</p>
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => speakInterviewerResponse(msg.content)}
                    ...
                    <Avatar className="w-12 h-12">
                      ...
                      <AvatarFallback className="flex items-center">选</AvatarFallback>
                    </Avatar>
                  </div>
                )}
              </div>
